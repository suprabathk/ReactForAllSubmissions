  ...
  return (
    <div className="flex flex-col justify-center text-white">
      ...
      <div className="flex gap-4 mt-2">
        <a
          className="text-center bg-gray-700 py-2 w-full rounded-lg mt-2 hover:text-white hover:border-white border font-semibold transition-all border-gray-400 text-gray-400"
